...
public class PublisherImpl extends Thread implements Publisher {
    ...
    private static String pathToDataset = "/home/helena/Desktop/DS_Project_2020/dataset1/DS_Dataset";
    ...
    public static void main(String[] args) {
        ...
        if(numOfPubs == 0){
            ...
            for(int i = 1; i <= numOfPubs; i++) {
                publishers.add(new PublisherImpl("192.168.2.6", 4321+i-1, i));
            }
            ...
            for (File file : files) {
                if (file.isFile()) {
                    ...
                    if(!name.startsWith("._")) {
                        ...
                        //System.out.println("NEIMAKI" +name);
        ...
        try {
            ...
            while (true) {
                try {
                    ...
                    push(newtopic.getArtist(),newtopic.getGenre(),newtopic.getTitle());
    ...
    public void push(String artist,String category, String song) throws IOException {
            ...
            if (artist.equals(this.topics.get(i).getArtist())) {
                if (song.equals(this.topics.get(i).getTitle())) {
                    ...
                    for (int j = 0; j < numOfChunks; j++) {
                        ...
                        this.topics.get(i).setAudioChunk(fileContent, offset, j, extra, numOfChunks);
                        chunks.add(this.topics.get(i));
