...
public class BrokerImpl2 extends Thread implements Broker, Serializable {
    ...
    private List<PublisherImpl> registeredPublishers = new ArrayList<PublisherImpl>() {
        {
            add(new PublisherImpl("192.168.2.6", 4321, 1));
        }

        {
            add(new PublisherImpl("192.168.2.6", 4322, 2));
        }
    };
        ...
        public void acceptConnection() {
            ...
            try {
                ...
                while (true) {
                    ...
                    String p = (String)inC.readObject();
    ...
    public void pull(MusicFile topic) {
        ...
        try {
            ...
            if (repl.equals("Yes")) {
                ...
                byte[] fileContent = (byte[]) inP.readObject();
                int offset = (int) inP.readObject();
                long extra = (long) inP.readObject();
                outC.writeObject(numOfChunks);
                outC.writeObject(fileContent);
                outC.writeObject(offset);
                outC.writeObject(extra);
                temp = (Long) inC.readObject();
